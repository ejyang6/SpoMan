...
public class Paging3VO {
	//페이징 처리관련 프로퍼티
	private int cpage3;//현재 보여줄 페이지 번호
	...
	public void init(HttpSession ses) {
		...
		//페이징 블럭 연산
		prevBlock =(cpage3-1)/pagingBlock * pagingBlock;
		  ...
		  StringBuilder buf=new StringBuilder()
				...
				buf.append("<li class='page-item'><a class='page-link' href='"+myctx+"/"+loc+qStr+"&cpage="+prevBlock+"'>");
				  ...
				  for(int i=prevBlock+1;i<=nextBlock-1 && i<=pageCount;i++) {
					  ...
					  buf.append("<li class='page-item "+css+"'><a class='page-link' href='"+myctx+"/"+loc+qStr+"&cpage3="+i+"'>");
					  buf.append(i);
					  buf.append("</a></li>");
				  }//for--------
				  ...
				  if(nextBlock<pageCount) {
						//이후 5개
						buf.append("<li class='page-item'><a class='page-link' href='"+myctx+"/"+loc+qStr+"&cpage3="+nextBlock+"'>");
						buf.append("Next");
						buf.append("</a></li>");
					}
